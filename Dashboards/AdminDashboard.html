...
<html lang="en">
  ...
  <body class="font-primary ">
    ...
    <main class="w-10/12 mx-auto mt-12">
        <h1 class="text-4xl font-semibold text-slate-500">Admin Dashboard</h1>
                ...
                <a href="./CustomerLog.html">
                    <div class="card card-border bg-base-300 shadow-xl">
                        <div class="card-body flex flex-col items-center justify-center text-center">
                          ...
                          <h2 class="card-title text-center">User Log</h2>  
                        </div>
                      </div>
                ...
                <a href="./CalculateBill.html">
                    <div class="card card-border bg-base-300 shadow-xl">
                        <div class="card-body flex flex-col items-center justify-center text-center">
                          ...
                          <h2 class="card-title text-center">Calculate Bill</h2>  
                        </div>
                      </div>
                </a>
                 ...
                 <a href="./DeleteUser.html">
                  <div class="card card-border bg-base-300 shadow-xl">
                      <div class="card-body flex flex-col items-center justify-center text-center">
                        ...
                        <h2 class="card-title text-center">Delete User</h2>  
                      </div>
                    </div>
                </a>
                 ...
                 <a href="./ReportsLog.html">
                  <div class="card card-border bg-base-300 shadow-xl">
                      <div class="card-body flex flex-col items-center justify-center text-center">
                        ...
                        <h2 class="card-title text-center">Report Log</h2>  
                      </div>
                    </div>
                </a>
               </div>
