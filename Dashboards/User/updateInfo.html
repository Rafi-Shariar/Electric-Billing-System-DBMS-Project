    ...
    <main class="font-primary w-10/12 mx-auto">
      ...
      <div class="">
          ...
          <div class="flex justify-start items-center ">
              <h1 class="text-center mt-10 text-3xl text-slate-500 font-semibold">Update Information</h1>
          ...
          <div class=" flex items-center justify-center pt-12">
              <fieldset class="fieldset bg-white border border-gray-300 p-6 rounded-lg shadow-lg w-8/12">
                  ...
                  <div class="mt-6 flex justify-center gap-10">
                      <button class="btn bg-blue-400 text-white px-6 py-2 rounded-md shadow-md hover:bg-blue-700 transition duration-300">Update</button>
                      <a class="btn bg-red-400 text-white px-6 py-2 rounded-md shadow-md hover:bg-red-700 transition duration-300" href="./UserDashboard.html">Cancle</a>
                  </div>
              </fieldset>
          </div>
